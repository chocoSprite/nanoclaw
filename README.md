...
- **Local audio transcription** — Slack 음성/오디오를 `whisper-cpp` + `ggml-large-v3-turbo` 로 로컬 transcribe 후 agent 에 텍스트로 넘김
...
- `whisper-cpp` + `ggml-large-v3-turbo.bin` — Slack audio transcription
