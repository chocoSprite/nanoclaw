...
- **Skills** (`.agents/skills/`): unlikely to conflict unless you edited an upstream skill
...
- **Skills** (`.agents/skills/`): unlikely to conflict unless the user edited an upstream skill
...
1. Use the Read tool to read `.agents/skills/update-nanoclaw/diagnostics.md`.
