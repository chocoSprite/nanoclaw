...
**Never ask again**:
1. Replace contents of `.agents/skills/setup/diagnostics.md` with `# Diagnostics — opted out`
2. Replace contents of `.agents/skills/update-nanoclaw/diagnostics.md` with `# Diagnostics — opted out`
3. Remove the `## 9. Diagnostics` section from `.agents/skills/setup/SKILL.md` and the `## Diagnostics` section from `.agents/skills/update-nanoclaw/SKILL.md`
