...
- **Schedule tasks** — ask 패트 to set a reminder or create a scheduled NanoClaw task (e.g. "remind me tomorrow to review the PR")
...
> 3. A response from 패트 should appear within a few seconds
>
