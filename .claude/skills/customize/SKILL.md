...
3. **Plan the changes** - Identify files to modify. If a skill exists for the request (e.g., `/add-slack` for Slack, `/add-gmail` for Gmail), invoke it instead of implementing manually.
